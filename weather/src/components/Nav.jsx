...
const Nav = ({ onSearch, onCurrentLocation }) => {
  ...
  return (
    <div className="m-4">
      <div className="flex flex-col items-center justify-between gap-4 lg:flex-row">
        ...
        >
          <img src={search1} alt="search" className="absolute left-3 w-4 h-4" />
          ...
          <input
            ...
            className="w-full py-2 pl-10 pr-4 text-sm text-black rounded-lg outline-none"
          />

          <button className="bg-[#050e1fde] text-white px-5 py-2 rounded-r-lg">
            Search
          </button>
        </form>
        ...
        <button
          ...
          className="flex gap-3 items-center px-4 py-2 text-sm font-medium text-white bg-green-500 rounded cursor-pointer"
        >
          <img src={location} alt="location" className="w-5 h-5" />
          <p>Current Location</p>
        </button>
